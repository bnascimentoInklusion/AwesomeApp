...
@class Xamarin_iOS__ShazamKit_SHSessionDelegate;
...
@class Xamarin_iOS__Chip_ChipDevicePairingDelegate;
@class Xamarin_iOS__Chip_ChipPersistentStorageDelegate;
...
@interface Xamarin_iOS__ShazamKit_SHSessionDelegate : NSObject<SHSessionDelegate> {
}
	-(id) init;
@end
...
@interface Xamarin_iOS__Chip_ChipDevicePairingDelegate : NSObject<CHIPDevicePairingDelegate> {
}
	-(id) init;
@end

@interface Xamarin_iOS__Chip_ChipPersistentStorageDelegate : NSObject<CHIPPersistentStorageDelegate> {
}
	-(id) init;
@end
